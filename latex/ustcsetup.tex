...
\ustcsetup{
  title              = {基于多模态的教学资源多标签知识点预测},
  title*             = {Prediction of Multi-label Knowledge of Teaching Resources Based on Multi-modality},
  author             = {肖桐},
  author*            = {Xiao Tong},
%   speciality         = {计算机科学与技术},
%   speciality*        = {Mathematics and Applied Mathematics},
  supervisor         = {刘淇教授},
  supervisor*        = {Prof. QiLiu},
  % date               = {2017-05-01},  % 默认为今日
  % professional-type  = {专业学位类型},
  % professional-type* = {Professional degree type},
  department         = {计算机科学与技术学院},  % 院系，本科生需要填写
  student-id         = {PB18000037},  % 学号，本科生需要填写
