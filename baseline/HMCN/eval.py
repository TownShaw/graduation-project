...
def eval(config: dict, model_name: str):
    ...
    model_save_path = os.path.join(config["data"]["model_save_dir"], model_name + ".Khan.model")
    ...
    dump_prediction(total_scores, total_labels, f"{model_name}.json", config[model_name]["threshold"])
...
if __name__ == "__main__":
    ...
    eval(config=config, model_name=model_name)
